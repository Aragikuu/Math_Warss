    ...
    <div class="row">
        <div class="col-md-6">
            <center> 
                ...
                <input type="button" value="Girar" onclick="miRuleta.startAnimation();" class="btn btn-warning btn-lg"
                       style="width: 200px;margin-left: 0px;border: 2px solid #FFFFFF;border-radius: 20px;">
            </center>
            <br>
            <br>
        </div>
...
<script>
    var miRuleta = new Winwheel({
        ...
        'segments':[
            ...
            {'fillStyle': '#e01423', 'text': 'Calculo'},
            {'fillStyle': '#23bb23', 'text': 'Pregunta 3'},
            {'fillStyle': '#4fa1de', 'text': 'Pregunta 4'},
